...
class EquilibriumMatchingDecompositionalNodeGenerator(ConditionalNodeGeneratorBase):
    ...
    def _fit_node_label_vocab(self, node_label_targets: List[np.ndarray]) -> None:
        ...
        self.num_node_label_classes_ = int(len(self.node_label_classes_))
        self.use_node_label_head = self.num_node_label_classes_ > 1
    ...
    def setup(
        ...
        self.model = EquilibriumMatchingDecompositionalNodeGeneratorModule(
            ...
            num_node_label_classes=self.num_node_label_classes_,
